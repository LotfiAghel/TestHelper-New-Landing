...
export const defaultMetadata = {
  ...
  title: {
    default:
      "تست هلپر | آزمون های بین المللی زبان انگلیسی - IELTS, TOEFL, GRE, PTE",
    template: "%s | تست هلپر",
  },
  description:
    "تست هلپر پلتفرم جامع آمادگی برای آزمون های بین المللی زبان انگلیسی آیلتس، تافل، GRE و PTE با آزمون های آزمایشی کامل، منابع معتبر و به روز",
  keywords: [
    "آیلتس",
    "تافل",
    "PTE",
  ...
  openGraph: {
    ...
    title:
      "تست هلپر | آزمون های بین المللی زبان انگلیسی - IELTS, TOEFL, GRE, PTE",
    description:
      "پلتفرم جامع آمادگی برای آزمون های بین المللی زبان انگلیسی آیلتس، تافل، GRE و PTE با آزمون های آزمایشی کامل، منابع معتبر و به روز",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "پلتفرم جامع آمادگی برای آزمون های بین المللی زبان انگلیسی آیلتس، تافل، GRE و PTE",
...
export const downloadPublicUserFile =
  serverBaseUrl + "/api/files2/DownloadUserPublicFile/";
