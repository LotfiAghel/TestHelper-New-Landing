...
export const metadata = {
    ...
    description: "آمادگی کامل آزمون GRE: ماک GRE رایگان، بهترین منابع و کتاب GRE، راهنمای نمره و امتیاز، تاریخ آزمون، GRE General و Subject، آموزش تضمینی و بهترین کلاس GRE.",
    keywords: [
        "gre",
        "آزمون gre",
        "آزمون جی آر ای",
                ...
                customFeatures={[
                    {
                        ...
                        items: [
                            "ماک GRE رایگان با بانک سؤال کامل",
                            "آزمون GRE آنلاین با تحلیل نمره",
                            "تمرین Verbal، Quantitative و Analytical Writing",
                        ],
                    ...
                    },
                    {
                        ...
                        items: [
                            "محاسبه نمره GRE و تبدیل به نمره کل",
                            "تحلیل پیشرفت و پیش‌بینی نمره نهایی",
                            "مقایسه GRE و GMAT برای انتخاب بهتر",
                        ],
                    ...
                    },
                    {
                        ...
                        items: [
                            "کلاس GRE آنلاین با پشتیبانی ۲۴ ساعته",
                            "راهنمای ثبت‌نام و تاریخ آزمون GRE 2022 و بعد",
                            "مشاوره برای انتخاب GMAT یا GRE",
                        ],
