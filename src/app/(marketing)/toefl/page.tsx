...
export const metadata = {
    ...
    openGraph: {
        title: "آزمون تافل (TOEFL) | ماک تافل رایگان، TPO و هوم ادیشن | تست‌هلپر",
        description:
            "آمادگی کامل آزمون تافل: TPO تافل، ماک تافل رایگان، تافل هوم ادیشن، خرید ووچر، TOEFL Listening و Speaking، منابع و کلاس تافل.",
        url: "/toefl",
        type: "website",
    },
};
                ...
                customFeatures={[
                    {
                        ...
                        items: [
                            "تمام TPO تافل (TPO 1 تا آخرین نسخه)",
                            "ماک رایگان تافل با نمره‌دهی دقیق",
                            "آزمون آزمایشی تافل آنلاین رایگان",
                        ],
                    ...
                    },
                    {
                        ...
                        items: [
                            "شبیه‌سازی تافل هوم ادیشن در خانه",
                            "خرید ووچر تافل با قیمت مناسب",
                            "راهنمای کامل ثبت‌نام و هزینه تافل",
                        ],
                    ...
                    },
                    {
                        ...
                        items: [
                            "TOEFL Listening با پاسخ‌های تشریحی",
                            "Speaking تافل با فیدبک لحظه‌ای",
                            "تمرین TOEFL 2023 با سؤالات به‌روز",
                        ],
                    ...
                    },
                    {
                        ...
                        items: [
                            "تفاوت TOEFL ITP و IBT و ITP IBT",
                            "منابع Cambridge TOEFL و TOEFL Bank",
                            "کلاس تافل آنلاین (TOEFL Kurs Online)",
                        ],
