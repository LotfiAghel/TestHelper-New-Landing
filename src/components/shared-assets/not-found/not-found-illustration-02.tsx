                ...
                <div className="mx-auto flex max-w-3xl flex-col items-start gap-8 md:gap-12 md:pr-8">
                    ...
                    <div className="flex flex-col gap-4 md:gap-6">
                        <div className="flex flex-col gap-3">
                            ...
                            <h1 className="text-display-md font-semibold text-primary md:text-display-lg lg:text-display-xl">یه مشکلی پیش اومده.</h1>
                        </div>
                        <p className="text-lg text-tertiary md:max-w-120 md:text-xl">به نظر میاد این صفحه وجود نداره یا جابجا شده.</p>
                    </div>
