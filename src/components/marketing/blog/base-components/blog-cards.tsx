...
export const Simple01Vertical = ({ article, imageClassName }: { article: Article; imageClassName?: string }) => (
    <article className="flex flex-col gap-4">
        <a href={`${article.category}/${article.slug}`} className="overflow-hidden rounded-2xl" tabIndex={-1}>
            <img
        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
                <span className="text-sm font-semibold text-brand-secondary">{article.category}</span>
                <div className="flex flex-col gap-1">
                    ...
                    <p className="line-clamp-2 text-md text-tertiary">{article.title}</p>
                </div>
            </div>
...
export const Simple02Vertical = ({
    ...
    <article className="flex flex-col gap-4">
        <a href={article.slug} className="overflow-hidden" tabIndex={-1}>
            <img src={article.mainimage.url} alt={article.title} className={cx("aspect-[1.5] w-full object-cover", imageClassName)} />
        </a>

        <div className="flex flex-col gap-5">
            <div className="flex flex-col items-start gap-3">
                <BadgeGroup addonText={article.category} size="md" theme={badgeTheme} color="brand" className="pr-3" iconTrailing={null}>
    ...
    return (
        <article className={cx("flex flex-col gap-4", className)}>
            <a href={article.link} className="overflow-hidden rounded-2xl" tabIndex={-1}>
                <img
                    src={article.mainimage.fullUrl}
                    alt={article.title}
                    className={cx("aspect-[1.5] w-full object-cover transition duration-100 ease-linear hover:scale-105", imageClassName)}
                />
            </a>

            <div className="flex flex-col gap-6 flex-auto justify-between">
                <div className="flex flex-col items-start gap-2">
                    <p className="text-sm font-semibold text-brand-secondary">
                        {article.author} • <time>{article.publishedAt}</time>
                    </p>
                    <div className="flex w-full flex-col gap-1">
                        ...
                        <p className="line-clamp-2 text-md text-tertiary">{article.SeoDescription}</p>
                    </div>
                </div>

                <div className="flex gap-2">

                    <Link key={tag.name} href={tag.href} className="rounded-xl outline-focus-ring focus-visible:outline-2 focus-visible:outline-offset-2">
...
export const Simple04Vertical = ({ article, imageClassName, className }: { article: Article; imageClassName?: string; className?: string }) => (
    <article className={cx("flex flex-col gap-4", className)}>
        <div className="relative">
            <a href={article.link} className="w-full" tabIndex={-1}>
                <img src={article.mainimage.fullUrl} alt={article.title} className={cx("aspect-[1.5] w-full object-cover", imageClassName)} />
            </a>
        ...
        <div className="flex flex-col items-start gap-5">
            ...
            <Button href={article.link} color="link-color" size="lg" iconTrailing={ArrowUpRight}>
                Read post
            </Button>
        </div>
    </article>
...
//         <a href={article.link} className="shrink-0 overflow-hidden" tabIndex={-1}>
//             <img src={article.mainimage.fullUrl} alt={article.title} className="h-60 w-full object-cover lg:h-50 lg:w-91.5" />
//         </a>
    ...
    <article className="flex flex-col gap-4 xl:flex-row xl:items-start">
        <a href={article.link} className="shrink-0 overflow-hidden rounded-2xl" tabIndex={-1}>
            <img
                src={article.mainimage.fullUrl}
                alt={article.title}
                className={cx("aspect-[1.5] w-full object-cover transition duration-100 ease-linear hover:scale-105 xl:w-91.5", imageClassName)}
            />
        </a>
        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                <p className="text-sm font-semibold text-brand-secondary">
                    <a href={article.author} className="rounded-xs outline-focus-ring focus-visible:outline-2 focus-visible:outline-offset-2">
                        {article.author}
                    </a>{" "}
