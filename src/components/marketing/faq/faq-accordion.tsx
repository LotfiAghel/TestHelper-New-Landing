...
const defaultFaqs = [
    {
        ...
        answer: "تست‌هلپر یه پلتفرمه برای تمرین و شبیه‌سازی آزمون‌های بین‌المللی زبان مثل آیلتس، تافل و جی‌آرای. اینجا می‌تونی با شرایط کاملاً شبیه آزمون اصلی تمرین کنی و آمادگی واقعی به دست بیاری.",
    },
    {
