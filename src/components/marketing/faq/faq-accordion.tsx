...
const defaultFaqs = [
    {
        question: 'تست‌هلپر چیه؟',
        answer: 'تست‌هلپر یک پلتفرم تخصصی برای تمرین و شبیه‌سازی آزمون‌های بین‌المللی زبان مثل IELTS، TOEFL و GRE است. در تست‌هلپر می‌تونی با فضای کاملاً مشابه آزمون واقعی تمرین کنی، سطح خودت رو بسنجی و برای روز آزمون کاملا آماده بشی.',
    },
    {
    ...
    },
    {
        ...
        answer: 'بله! چون آزمون‌ها زمان‌بندی مشابه آزمون اصلی رو دارن، می‌تونی دقیقا مثل شرایط واقعی تمرین کنی و مهارت مدیریت زمانت رو قوی‌تر کنی.',
    },
    {
