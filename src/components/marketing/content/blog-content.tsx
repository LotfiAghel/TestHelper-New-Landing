...
import { Article } from "../blog/base-components/blog-cards";
import { DetailArticle } from "@/types";
import HTMLReactParser from "html-react-parser";
import { strapiBaseUrl } from "@/utils/consts";
// import { FAQ } from "../faq/faq-accordion";
import Image from "next/image";
import { Fragment } from "react";

export const BlogContent = ({ blogItem, allPosts, headers }: {
    blogItem: DetailArticle,
    allPosts: Article[],
    headers: any[]
}) => {
                                        ...
                                        <>
                                            {headers.map(item => (
                                                <li key={item} className={`transition-colors`}>
                                                    <Link
                                                        href={`#${item}`}
                                                        className={`block truncate text-secondary hover:text-brand-tertiary`}
                                                    >
