...
import { MetricsMini } from "../metrics/metrics-mini";
    ...
    return (
        <Fragment>
            <section className="relative py-16 shadow-xs lg:flex lg:h-screen lg:items-center lg:py-12">
                ...
                <div className="relative mt-12 h-48 w-full px-4 md:px-8 lg:absolute lg:inset-y-0 lg:left-0 lg:mt-0 lg:h-full lg:w-1/2 lg:px-0">
