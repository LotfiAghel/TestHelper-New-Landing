...
const getSizeClasses = (
    ...
    leading: {
        md: {
            root: cx("py-1 ps-1 pe-2 text-xs font-medium", !text && !icon && "pe-1"),
            addon: cx("px-2 py-0.5", theme === "modern" && "gap-1 px-1.5", text && "me-2"),
            icon: "ms-1 size-4",
        },
        lg: {
            root: cx("py-1 ps-1 pe-2 text-sm font-medium", !text && !icon && "pe-1"),
    ...
    trailing: {
        md: {
            root: cx("py-1 ps-3 pe-1 text-xs font-medium", theme === "modern" && "ps-2.5"),
            addon: cx("py-0.5 ps-2 pe-1.5", theme === "modern" && "ps-2 pe-1.5", text && "ms-2"),
            icon: "ms-0.5 size-3 stroke-[3px]",
            dot: "me-1.5",
        },
        lg: {
            root: "py-1 pe-1 ps-3 text-sm font-medium",
            addon: cx("py-0.5 ps-2.5 pe-2", theme === "modern" && "ps-2 pe-1.5", text && "ms-2"),
